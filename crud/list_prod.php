...
<link href="list_prod_files/default.css" rel="stylesheet" type="text/css" media="all">
<link href="list_prod_files/stylesheet.css" rel="stylesheet" type="text/css" media="all">
...
<script src="list_prod_files/jquery.js"></script>
<!-- bxSlider Javascript file -->
<script src="list_prod_files/jquery_003.js"></script>
<script src="list_prod_files/script.js" type="text/javascript"></script>

<!-- bxSlider CSS file -->
<link href="list_prod_files/jquery.css" rel="stylesheet">
<!-- Responsive -->
<link href="list_prod_files/responsive.css" rel="stylesheet">
  ...
  <header class="clearfix">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Logo_Cont left"><!--Logo_Cont Start-->
           ...
           <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/index.html"><img src="list_prod_files/logo.png" alt=""></a>
  ...
  <div class="section content_section">
	<div class="container">
		<div class="filable_form_container">
			<form id="list_prod_form" action="api/delete.php?method=delete_prod_all" method="POST">
			<div class="mange_buttons">
				<ul>
				 ...
				 <div class="Search">
					...
					<li><a href="add_prod.php">Create Product</a></li>
					<li><button class="delete_multi" type="submit">Delete</button></li>
				</ul>
			</div>
			<div class="table_container_block">
				<table width="100%">
					<thead>
						<tr>
						<th width="10%">
							<input type="checkbox" class="checkbox" id="check_multi" onchange="get_checked(this)"> <label class="css-label mandatory_checkbox_fildes" for="check_multi"></label>
						</th>
					...
					$conn = new db_class();
					$count=$conn->get_count_prod();
                    $no_of_rows=$count->fetch_assoc()['total_rows']; 
                    // print_r($ntotal_pageso_of_rows);
				    $total_pages = ceil($no_of_rows / $no_of_records_per_page);
					$read = $conn->read_prod_list($no_of_records_per_page,$offset);
					while($fetch = $read->fetch_assoc()){ 

				?>
						<tr>
							<td>
								<input type="checkbox" class="checkbox check_box" id="checkbox<?php echo $fetch['id'];?>" value="<?php echo $fetch['id'];?>" name="check[]"> <label class="css-label mandatory_checkbox_fildes" for="checkbox<?php echo $fetch['id'];?>"></label>
							</td>
							<td><?php echo $fetch['prod_name'];?></td>
							<td style="text-align:center"><img src="<?php echo $fetch['prod_image'];?>" style="width:80px; height:auto;"></td>
							<td style="text-align:right">Rs <?php echo $fetch['prod_price'];?></td>
							<td><?php echo $fetch['cate_name'];?></td>
							<td>
								<div class="buttons">
								  <a href="edit_prod.php?id=<?php echo $fetch['id'];?>"class="btn btn_edit">Edit</a>
								  <a onclick="delete_product(<?php echo $fetch['id'];?>)" class="btn btn_delete">Delete</a>
								</div>								
							</td>
						</tr>
				...
				?>
						<!-- <tr>
							...
							<td>Nexus 5</td>
							<td style="text-align:center"><img src="list_prod_files/noimage.jpg" style="width:80px; height:auto;"></td>
...
?>
        ...
        <li><a href="?pageno=<?php echo $total_pages; ?>">Last(<?php echo $total_pages; ?>)</a></li>
...
<div class="section clearfix section-colored7"><!--section start--> 
	...
	<div class="container"><!--container Start-->
		...
		<div class="Download_Cont_Top_Left left"><!--Download_Cont_Top Start-->
			<img src="list_prod_files/icon5.png" alt=""> <h1 style="display:inline;">FREE: Men Are From Mars</h1> <a href="#">Download Now</a>
  ...
  <footer class="footer_wrapper">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Footer_Cont_Top clearfix"><!--Footer_Cont_Top Start-->
			...
			<span class="left"><img src="list_prod_files/foot_logo.png" alt=""></span>
...
Live a life without regrets and take action today!</p>
		...
		<div class="Footer_Cont_Top2 clearfix"><!--Footer_Cont_Top2 Start-->
			...
			<h1>Call Us Today! (02) 9017 8413</h1>
			 <a href="#">Book an Appointment <img src="list_prod_files/icon7.png" alt=""></a>
 			 <a href="#">Contact a Consultant <img src="list_prod_files/icon6.png" alt=""></a>
...
<script type="text/javascript" src="list_prod_files/jquery_002.js"></script>	
