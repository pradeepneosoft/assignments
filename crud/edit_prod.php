...
<link href="edit_prod_files/default.css" rel="stylesheet" type="text/css" media="all">
<link href="edit_prod_files/stylesheet.css" rel="stylesheet" type="text/css" media="all">
<link href="edit_prod_files/jquery.css" rel="stylesheet">
<!-- Responsive -->
<link href="edit_prod_files/responsive.css" rel="stylesheet">
...
<script src="edit_prod_files/jquery.js"></script>
<!-- bxSlider Javascript file -->
<!-- <script src="edit_prod_files/jquery_003.js"></script> -->


 <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/jquery.validate.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/additional-methods.js"></script>
 <script src="edit_prod_files/script.js" type="text/javascript"></script>
...
<div id="wrapper"> 
 ...
 <!--header-starts-->
  <header class="clearfix header_fixed">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Logo_Cont left"><!--Logo_Cont Start-->
           ...
           <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/index.html"><img src="edit_prod_files/logo.png" alt=""></a>
  ...
  <?php     require 'api/category.php';
					$conn = new db_class();
					$read = $conn->get_prod_data($_REQUEST['id']);
					$fetch=$read->fetch_assoc();
					// print_r($fetch); die();
					?>
  <form id="prod_add_form" method="POST" action="api/update.php" enctype="multipart/form-data">
		...
		<div class="filable_form_container">
			<div class="form_container_block">
				<ul>
					<li class="fileds">
						<div class="name_fileds">
                            ...
                            <input name="id" type="hidden" value="<?=$fetch['id'];?>">
							<input name="prod_name" type="text" value="<?=$fetch['prod_name'];?>">  
						</div>
					</li>
					<li class="fileds">
						<div class="name_fileds">
							<label>Product Price</label>
							<input name="price" type="number" value="<?=$fetch['prod_price'];?>"> 
						</div>
					</li>
					<li class="fileds">
						<div class="upload_fileds">
							<label>Upload Image</label>
							<input id="uploadFile" type="file" placeholder="Choose File" class="" name="prod_image">
							<input type="hidden" name="img_link" value="<?php echo $fetch['prod_image'];?>">
							<img src="<?php echo $fetch['prod_image'];?>" style="width:80px; height:auto;">
						</div>						
					</li>
					<li class="fileds">
						<div class="name_fileds">
							<label>Select Category</label>
							<select name="category" class="select" style="z-index: 10; opacity: 0;">
					...
					$read1 = $conn->read();
				// print_r($read);die();
					while($fetch1 = $read1->fetch_array()){ 
						if($fetch['prod_category']==$fetch1['id'])
						{
				echo "<option value=".$fetch1['id']." selected>".$fetch1['cate_name']."</option>";

						}
						else
						{	
				echo "<option value=".$fetch1['id']." >".$fetch1['cate_name']."</option>";
				         }
				}?>
				...
				<div class="next_btn_block">
					<div class="next_btn">
						<a id="submit_button">Submit<span><img src="edit_prod_files/small_triangle.png" alt="small_triangle"> </span></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="section clearfix section-colored7"><!--section start--> 
	...
	<div class="container"><!--container Start-->
		...
		<div class="Download_Cont_Top_Left left"><!--Download_Cont_Top Start-->
			<img src="edit_prod_files/icon5.png" alt=""> <h1 style="display:inline;">FREE: Men Are From Mars</h1> <a href="#">Download Now</a>
  ...
  <footer class="footer_wrapper">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Footer_Cont_Top clearfix"><!--Footer_Cont_Top Start-->
			...
			<span class="left"><img src="edit_prod_files/foot_logo.png" alt=""></span>
...
Live a life without regrets and take action today!</p>
		...
		<div class="Footer_Cont_Top2 clearfix"><!--Footer_Cont_Top2 Start-->
			...
			<h1>Call Us Today! (02) 9017 8413</h1>
			 <a href="#">Book an Appointment <img src="edit_prod_files/icon7.png" alt=""></a>
 			 <a href="#">Contact a Consultant <img src="edit_prod_files/icon6.png" alt=""></a>
...
<!-- <script type="text/javascript" src="edit_prod_files/jquery_002.js"></script>	 -->
